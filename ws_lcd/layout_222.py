...
class Layout_222(Layout):
    def __init__(self):
        ...
        self.row_4_y = self.sep_4_y + self.sh1 + 2
...
#        self.wi.draw_borders()
        ...
        self.wv.set_position(28, self.row_1_y)

        self.wu   = Component(32, self.ch2, font_size=16)
        self.wu.set_position(92, self.row_1_y)
...
#        self.gi.set_text("1h", align=1)
        ...
        self.gv   = Component(64, self.ch2, font_size=18, format_string="{0:.2f}")
        self.gv.set_position(28, self.row_2_y)

        self.gu   = Component(32, self.ch2, font_size=16)
        self.gu.set_position(92, self.row_2_y)
        ...
        self.ev   = Component(64, self.ch2, font_size=18, format_string="{0:.3f}")
        self.ev.set_position(28, self.row_3_y)

        self.eu   = Component(32, self.ch2, font_size=16)
        self.eu.set_position(92, self.row_3_y)
